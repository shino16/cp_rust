...
impl<M: Mod> GField<M> {
    ...
    pub fn new(val: u32) -> Self {
        GField::from_raw(reduce::<M>(val as u64 * M::R2 as u64))
    }
    ...
    pub fn grow(self) -> GFieldGrow<M> {
        GFieldGrow::from_raw((self.val as u64) << 32)
    }
    pub fn mul_unreduced<T: Into<Self>>(self, rhs: T) -> GFieldGrow<M> {
        GFieldGrow::from_raw(self.val as u64 * rhs.into().val as u64)
    }
...
impl<M: Mod> ops::Add<Self> for GFieldGrow<M> {
    type Output = Self;
...
impl<M: Mod> ops::AddAssign<Self> for GFieldGrow<M> {
...
impl<M: Mod> From<GFieldGrow<M>> for GField<M> {
...
impl<M: Mod, T: Into<GField<M>>> ops::AddAssign<T> for GField<M> {
...
impl<M: Mod, T: Into<GField<M>>> ops::SubAssign<T> for GField<M> {
...
impl<M: Mod, T: Into<GField<M>>> ops::MulAssign<T> for GField<M> {
...
macro_rules! impl_binop {
    ($(($Op:ident, $op:ident, $OpAssign:ident, $op_assign:ident)),*) => { $(
        impl<M: Mod, T: Into<GField<M>>> ops::$Op<T> for GField<M> {
            type Output = Self;
...
impl<M: Mod> ops::Neg for GField<M> {
    type Output = Self;
    fn neg(self) -> Self {
